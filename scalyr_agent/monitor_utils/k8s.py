...
class KubernetesCache( object ):
    ...
    def replicaset( self, namespace, name, current_time=None ):
        """
            Returns cached replicaset info for the replicaset specified by namespace and name
            or None if no replicaset matches.

            Querying the replicaset information is thread-safe but the returned object should
            not be written to.
        """
        return self._replicasets.lookup( namespace, name, current_time )
